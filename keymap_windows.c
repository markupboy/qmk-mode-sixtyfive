...
[1] = LAYOUT_65_ansi_blocker(
    ...
    _______, _______, _______,                            KC_MPLY,                   RGB_TOG, _______,          KC_HOME, KC_PGDN, KC_END
),
[2] = LAYOUT_65_ansi_blocker(
    ...
    _______, LCTL(KC_Z) , _______, LCTL(KC_C), LCTL(KC_V), QK_BOOT, _______, _______, _______, _______  , _______, _______,          KC_PGUP, _______,
